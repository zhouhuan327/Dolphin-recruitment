    ...
    if(username=="null"||username==undefined||username==null){
        ...
        if(rolename=="user"){
            $('.resume').click(function () {
                window.location.href="page/resume/resume.html"
            })
          $('.personcenter').click(function () {
              window.location.href="page/personal_center/personal_center.html"
          })
            $('.setting').click(function () {
                window.location.href="page/personal_center/personal_center.html?page=setting"
            })
            $('.mycollect').click(function () {
                window.location.href="page/personal_center/personal_center.html?page=collect"
            })
        }
        if(rolename=="company"){
